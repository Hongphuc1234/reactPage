...
<form  className="form" id="form-1">
                ...
                <div className="form-group">
                    ...
                    <input id="name" name='name' type="text" placeholder="VD: Hoàng Hồng Phúc"
                        className="form-control1" value={username} onChange={(e) => handleInputChange(e)}/>
                ...
                <div className="form-group">
                    ...
                    <input id="email" name="email" type="text" placeholder="VD: phuc@gmail.com"
                        className="form-control1" value={email} onChange={(e) => handleInputChange(e)}/>
                    <i className="fa-solid fa-user form-user"></i>
                    <span className="form-message"></span>
                ...
                <div className="form-group">
                    ...
                    <input id="phone" name="phone" type="text" placeholder="Nhập mật khẩu"
                        className="form-control1" value={phone} onChange={(e) => handleInputChange(e)}/>
                    <i className="fa-solid fa-user form-user"></i>
                    <span className="form-message"></span>
                ...
                <div className="form-group">
                    <label  className="form-label">Số điện thoại</label>
                    <input id="birthday" name="birthday" type="date" placeholder="Nhập mật khẩu"
                        className="form-control1" value={birthday} onChange={(e) => handleInputChange(e)}/>
                    <i className="fa-solid fa-user form-user"></i>
                    <span className="form-message"></span>
                ...
                <div className="form-group">
                    ...
                    <input id="password" name="password" type="password" placeholder="Nhập mật khẩu"
                        className="form-control1" value={password} onChange={(e) => handleInputChange(e)}/>
                ...
                <div className="form-group">
                    ...
                    <input id="confirmPassword" name="password_confirmation" placeholder="Nhập lại mật khẩu"
                        type="password" className="form-control1" value={confirmPassword} onChange={(e) => handleInputChange(e)}/>
                    <i className="fa-solid fa-user-lock form-lock"></i>
                    <span className="form-message"></span>
                    <i className="fa-solid fa-eye-slash form-eye-slash"></i>
                </div>

                <button className="form-submit" onClick={(e) => handleSubmit(e)} type='submit'>Đăng ký</button>
            </form>
            )
            }
