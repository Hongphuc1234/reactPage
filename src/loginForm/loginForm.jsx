...
import axios from '../api/axios'// THÊM IMPORT AXIOS
...
return(
    ...
    <form onSubmit={handleSubmit}>
          ...
          <label className="label" for="form3Example3">Phone Number</label>
          
            <input type="number" id="form3Example3" className="form-control form-control-lg"
              placeholder="Enter a valid email address"  aria-describedby="phoneHelp"
                  value={phone} onChange ={(event) => setPhone(event.target.value)}/>
            {errors['phone'] !== '' && <span className="error">{errors['phone']}</span>}
          </div>

          <div className="form-outline mb-3">
          <label className="label" for="form3Example4">Password</label>
          ...
          <div className="text-center text-lg-start mt-4 pt-2">
            ...
            <p className="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="#!"
                className="link-danger"><Link to={'/register'}>Register</Link></a></p>
          </div>
